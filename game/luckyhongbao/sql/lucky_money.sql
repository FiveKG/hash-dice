CREATE USER lucky_money_user WITH PASSWORD 'pass_2019';
CREATE DATABASE lucky_money OWNER lucky_money_user;
grant select,insert,update,delete on all tables in schema public to lucky_money_user; 
grant select,usage,update on all sequences in schema public to lucky_money_user;
grant execute on all functions in schema public to lucky_money_user;
grant references, trigger on all tables in schema public to lucky_money_user;
grant create on schema public to lucky_money_user;
grant usage on schema public to lucky_money_user;
