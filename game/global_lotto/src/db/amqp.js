...
const amqpOption = {
    protocol : "amqp",
    hostname : process.env.GLOBAL_LOTTO_RABBIT_HOST || rabbitmq.host,
    port     : Number(port),
    username : process.env.GLOBAL_LOTTO_RABBIT_USER || rabbitmq.user,
    password : process.env.GLOBAL_LOTTO_RABBIT_PASS || rabbitmq.pwd,
    heartbeat: 300
};
