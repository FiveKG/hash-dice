...
let port = process.env.HASH_MINUTE_LOTTERY_SERVER_PORT || 13024 // = sb.get_config("service_port", `${service_name}`);
let host = process.env.HASH_MINUTE_LOTTERY_SERVER_HOST || "0.0.0.0" // = sb.get_config("service_port", `${service_name}`);
