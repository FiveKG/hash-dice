...
const port = process.env.SNATCH_TREASURE_RABBIT_PORT || rabbitmq.port
const amqpOption = {
    protocol : "amqp",
    hostname : process.env.SNATCH_TREASURE_RABBIT_HOST || rabbitmq.host,
    port     : Number(port),
    username : process.env.SNATCH_TREASURE_RABBIT_USER || rabbitmq.user,
    password : process.env.SNATCH_TREASURE_RABBIT_PASS || rabbitmq.pwd,
    heartbeat: 300
};
