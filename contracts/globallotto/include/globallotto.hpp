...
class [[eosio::contract("globallotto")]] globallotto : public contract {
  public:
    using contract::contract;
    globallotto(name receiver, name code, datastream<const char*> ds):contract(receiver, code, ds) {};
     ...
     * @param bet_time    投注时间
     */
    ACTION bet(name bet_name, string bet_num, asset& quantity, uint64_t game_id, time_point_sec bet_time);
