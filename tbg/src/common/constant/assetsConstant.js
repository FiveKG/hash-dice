 ...
 * 仅全球合伙人独享
 */
const GLOBAL_PARTNER_ASSETS_PACKAGE_50 = 50;
const GLOBAL_PARTNER_ASSETS_PACKAGE_100 = 100;
const GLOBAL_PARTNER_ASSETS_PACKAGE_200 = 200;
const GLOBAL_PARTNER_ASSETS_PACKAGE_500 = 500;
...
const GLOBAL_PARTNER_MULTIPLE_50 = 2;
const GLOBAL_PARTNER_MULTIPLE_100 = 2.5;
const GLOBAL_PARTNER_MULTIPLE_200 = 3;
const GLOBAL_PARTNER_MULTIPLE_500 = 3;

// 资产包进入线性释放池倍数
const RELEASE_POOL_MULTIPLE_50 = 4;
const RELEASE_POOL_MULTIPLE_100 = 4.5;
const RELEASE_POOL_MULTIPLE_200 = 5;
const GLOBAL_PARTNER_RELEASE_POOL_50 = 4;
const GLOBAL_PARTNER_RELEASE_POOL_100 = 4.5;
const GLOBAL_PARTNER_RELEASE_POOL_200 = 5;
const GLOBAL_PARTNER_RELEASE_POOL_500 = 5;
...
const GLOBAL_PARTNER_SALEABLE_50 = 1.3;
const GLOBAL_PARTNER_SALEABLE_100 = 1.4;
const GLOBAL_PARTNER_SALEABLE_200 = 1.5;
const GLOBAL_PARTNER_SALEABLE_500 = 1.6;
...
const CONSTANT = {
    ...
    "GLOBAL_PARTNER_ASSETS_PACKAGE_50": GLOBAL_PARTNER_ASSETS_PACKAGE_50,
    "GLOBAL_PARTNER_ASSETS_PACKAGE_100": GLOBAL_PARTNER_ASSETS_PACKAGE_100,
    "GLOBAL_PARTNER_ASSETS_PACKAGE_200": GLOBAL_PARTNER_ASSETS_PACKAGE_200,
    "GLOBAL_PARTNER_ASSETS_PACKAGE_500": GLOBAL_PARTNER_ASSETS_PACKAGE_500,
    "GLOBAL_PARTNER_MULTIPLE_50": GLOBAL_PARTNER_MULTIPLE_50,
    "GLOBAL_PARTNER_MULTIPLE_100": GLOBAL_PARTNER_MULTIPLE_100,
    "GLOBAL_PARTNER_MULTIPLE_200": GLOBAL_PARTNER_MULTIPLE_200,
    "GLOBAL_PARTNER_MULTIPLE_500": GLOBAL_PARTNER_MULTIPLE_500,
    "GLOBAL_PARTNER_RELEASE_POOL_50": GLOBAL_PARTNER_RELEASE_POOL_50,
    "GLOBAL_PARTNER_RELEASE_POOL_100": GLOBAL_PARTNER_RELEASE_POOL_100,
    "GLOBAL_PARTNER_RELEASE_POOL_200": GLOBAL_PARTNER_RELEASE_POOL_200,
    "GLOBAL_PARTNER_RELEASE_POOL_500": GLOBAL_PARTNER_RELEASE_POOL_500,
    "GLOBAL_PARTNER_SALEABLE_50": GLOBAL_PARTNER_SALEABLE_50,
    "GLOBAL_PARTNER_SALEABLE_100": GLOBAL_PARTNER_SALEABLE_100,
    "GLOBAL_PARTNER_SALEABLE_200": GLOBAL_PARTNER_SALEABLE_200,
    "GLOBAL_PARTNER_SALEABLE_500": GLOBAL_PARTNER_SALEABLE_500,
 ...
 * @property { number } GLOBAL_PARTNER_ASSETS_PACKAGE_50
 * @property { number } GLOBAL_PARTNER_ASSETS_PACKAGE_100
 * @property { number } GLOBAL_PARTNER_ASSETS_PACKAGE_200
 * @property { number } GLOBAL_PARTNER_ASSETS_PACKAGE_500
 * @property { number } GLOBAL_PARTNER_MULTIPLE_50
 * @property { number } GLOBAL_PARTNER_MULTIPLE_100
 * @property { number } GLOBAL_PARTNER_MULTIPLE_200
 * @property { number } GLOBAL_PARTNER_MULTIPLE_500
 * @property { number } GLOBAL_PARTNER_RELEASE_POOL_50
 * @property { number } GLOBAL_PARTNER_RELEASE_POOL_100
 * @property { number } GLOBAL_PARTNER_RELEASE_POOL_200
 * @property { number } GLOBAL_PARTNER_RELEASE_POOL_500
 * @property { number } GLOBAL_PARTNER_SALEABLE_50
 * @property { number } GLOBAL_PARTNER_SALEABLE_100
 * @property { number } GLOBAL_PARTNER_SALEABLE_200
 * @property { number } GLOBAL_PARTNER_SALEABLE_500
