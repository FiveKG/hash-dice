...
async function investAirdrop(accountName, create_time) {
    try {
        ...
        if (total <= TBG_ALLOCATE.BIND_MEMBER_LIMIT) {
            ...
            if (!userReferrer) {
                const bindAirdrop = TBG_ALLOCATE.BIND_ACCOUNT_AIRDROP + TBG_ALLOCATE.BIND_REFERRER_AIRDROP;
                ...
                bindData = {
                    ...
                    "referrer": {
                        "updateTbgBalance": [ accountName, TBG_ALLOCATE.BIND_REFERRER_AIRDROP, 0, 0 ],
                        "insertBalanceLog": [ accountName, TBG_ALLOCATE.BIND_REFERRER_AIRDROP, reCurrentBalance, bindId, {}, reBalanceRemark, now ]
                    }
                }
            }
        }
        ...
        if (total <= TBG_ALLOCATE.TBG_1_MEMBER_LIMIT && df.differenceInHours(now, create_time) < 48) {
            ...
            if (!userReferrer) {
                const tbg1Airdrop = TBG_ALLOCATE.TBG_1_ACCOUNT_AIRDROP + TBG_ALLOCATE.TBG_1_REFERRER_AIRDROP;
                ...
                tbg1Data = {
                    ...
                    "referrer": {
                        "updateTbgBalance": [ accountName, TBG_ALLOCATE.TBG_1_REFERRER_AIRDROP, 0, 0 ],
                        "insertBalanceLog": [ accountName, TBG_ALLOCATE.TBG_1_REFERRER_AIRDROP, reCurrentBalance, tbg1Id, {}, reBalanceRemark, now ]
                    }
                }
            }
        }
