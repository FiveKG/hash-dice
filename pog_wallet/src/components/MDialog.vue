<template>
  <div>
    ...
    <div class="fingerprint" @click="fingerprintState = !fingerprintState" v-if="$store.state.wallet.fingerprintAuth && showFingerprint">
  ...
  <!-- <div>
    <div class="alert-dialog-title title">{{$t('common.verify_pwd')}}</div>

    <div class="alert-dialog-content">
      <input type="password" class="text-input input" placeholder="" maxlength="16" :value="iptValue" @input="$emit('listenInput', $event.target.value)" v-focus>
    </div>

    <div class="alert-dialog-footer alert-dialog-footer--rowfooter action">
      <button class="alert-dialog-button alert-dialog-button--rowfooter" @click="cancel">{{$t('common.cancel')}}</button>
      <button class="alert-dialog-button alert-dialog-button--rowfooter confirm" @click="confirm">{{$t('common.confirm')}}</button>
    </div>
  </div> -->
</template>
