...
export default {
  ...
  methods: {
    clickImport() {
      // this.$router.push('addWallet/importWallet')
      this.$router.push({
        name: 'ImportWallet',
        query: {
          back: 4
    ...
    clickConfirm() {
      if (this.type === 'friend') {
        // this.$router.push('addWallet/createAccount?type=order&json='+this.json)
        this.$router.push({
          name: 'CreateAccount',
          query: {
            type: 'order',
      ...
      switch (type) {
        ...
        case 'activation':
          ...
          if (activation_code) {
            ...
            // this.$router.push('addWallet/friendCreation?route=activation')
            this.$router.push({
              name: 'FriendCreation',
              query: {
                route: 'activation',
