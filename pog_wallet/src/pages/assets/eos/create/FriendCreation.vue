<template>
  <v-ons-page>
    ...
    <div class="content">
      <vheader :title="route === 'friend' ? $t('assets.friend_creation'):$t('assets.activation_code')" :background="'#ec565a'" :color="'#fff'" white />
      <attention></attention>
      <div class="layout">
        ...
        try {
          ...
          this.$router.push({
            ...
            query: {
              ...
              publicKey: publicKey,
              // back: this.$route.query.back ? this.$route.query.back : ''
            }
          })
        }
        this.loading = false
