    ...
    <vpage>
      <slot>
        <div class="container">
          ...
          <div class="bet-item" v-if="BetDetail.bet_num != ''">
          ...
          <div class="info">
            ...
            <div class="content">第 {{BetDetail.periods}} 期 <span v-if="BetDetail.bet_num == 'color:rgb(218, 178, 121);'" style="">(未开奖)</span> </div>
          </div>
          <div class="info">
          ...
          <div class="info">
            ...
            <div class="content">{{BetDetail.reward_time}} Key</div>
          </div>
          <div class="info">
...
.container .bet-item{
  height: 0.8rem;line-height: 0.8rem;color: white;
}
